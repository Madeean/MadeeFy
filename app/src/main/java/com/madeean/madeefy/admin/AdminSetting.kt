...
class AdminSetting : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_email_user_person = findViewById(R.id.tv_email_admin_person)
        tv_nama_user_person = findViewById(R.id.tv_nama_admin_person)
    ...
    private fun logoutHandle() {
        val dialog = ProgressDialog(this@AdminSetting)
        ...
        tampilData.enqueue(object : Callback<ModelLogout> {
            override fun onResponse(call: Call<ModelLogout>, response: retrofit2.Response<ModelLogout>) {
                ...
                if(response.isSuccessful){
                    ...
                    Toast.makeText(this@AdminSetting, "Berhasil Logout", Toast.LENGTH_SHORT)
                    val intent:Intent = Intent(this@AdminSetting,MainActivity::class.java)
                    ...
                    Toast.makeText(this@AdminSetting, "Gagal Logout", Toast.LENGTH_SHORT)
                }
            }

            override fun onFailure(call: Call<ModelLogout>, t: Throwable) {
                dialog.hide()
                Toast.makeText(this@AdminSetting,"Gagal login, tidak dapat menghubungi server", Toast.LENGTH_SHORT)
                t.printStackTrace()
            }
        })
    }
